...
public class CreateAddressRequest  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    private esb_rbm_account.address.CreateAddressRequestBody body;
    ...
    public CreateAddressRequest(
           ...
           esb_rbm_account.address.CreateAddressRequestBody body) {
    ...
    /**
     * Gets the contextIntegrator value for this CreateAddressRequest.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this CreateAddressRequest.
     * 
    ...
    /**
     * Gets the body value for this CreateAddressRequest.
     * 
     * @return body
     */
    public esb_rbm_account.address.CreateAddressRequestBody getBody() {
        return body;
    }


    /**
     * Sets the body value for this CreateAddressRequest.
     * 
     * @param body
     */
    public void setBody(esb_rbm_account.address.CreateAddressRequestBody body) {
        this.body = body;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateAddressRequest)) return false;
