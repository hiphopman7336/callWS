...
public class CreateAddressResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    private esb_rbm_account.address.CreateAddressResponseBody body;
    ...
    public CreateAddressResponse(
           ...
           esb_rbm_account.address.CreateAddressResponseBody body) {
    ...
    /**
     * Gets the contextIntegrator value for this CreateAddressResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this CreateAddressResponse.
     * 
    ...
    /**
     * Gets the body value for this CreateAddressResponse.
     * 
     * @return body
     */
    public esb_rbm_account.address.CreateAddressResponseBody getBody() {
        return body;
    }


    /**
     * Sets the body value for this CreateAddressResponse.
     * 
     * @param body
     */
    public void setBody(esb_rbm_account.address.CreateAddressResponseBody body) {
        this.body = body;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateAddressResponse)) return false;
        CreateAddressResponse other = (CreateAddressResponse) obj;
