...
public class CheckDebtRequest  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    private esb_rbm_account.xsd.CheckDebtRequestBody body;

    public CheckDebtRequest() {
    }

    public CheckDebtRequest(
           esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator,
           esb_rbm_account.xsd.CheckDebtRequestBody body) {
    ...
    /**
     * Gets the contextIntegrator value for this CheckDebtRequest.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this CheckDebtRequest.
     * 
    ...
    /**
     * Gets the body value for this CheckDebtRequest.
     * 
     * @return body
     */
    public esb_rbm_account.xsd.CheckDebtRequestBody getBody() {
        return body;
    }


    /**
     * Sets the body value for this CheckDebtRequest.
     * 
     * @param body
     */
    public void setBody(esb_rbm_account.xsd.CheckDebtRequestBody body) {
        this.body = body;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CheckDebtRequest)) return false;
        CheckDebtRequest other = (CheckDebtRequest) obj;
