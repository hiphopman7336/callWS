...
public class CheckDebtResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    private esb_rbm_account.xsd.CheckDebtResponseBody body;

    public CheckDebtResponse() {
    }

    public CheckDebtResponse(
           esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator,
           esb_rbm_account.xsd.CheckDebtResponseBody body) {
    ...
    /**
     * Gets the contextIntegrator value for this CheckDebtResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this CheckDebtResponse.
     * 
    ...
    /**
     * Gets the body value for this CheckDebtResponse.
     * 
     * @return body
     */
    public esb_rbm_account.xsd.CheckDebtResponseBody getBody() {
        return body;
    }


    /**
     * Sets the body value for this CheckDebtResponse.
     * 
     * @param body
     */
    public void setBody(esb_rbm_account.xsd.CheckDebtResponseBody body) {
        this.body = body;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CheckDebtResponse)) return false;
        CheckDebtResponse other = (CheckDebtResponse) obj;
