...
public class CreateBAResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    private esb_rbm_account.xsd.CreateBAResponseBody body;

    public CreateBAResponse() {
    }

    public CreateBAResponse(
           esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator,
           esb_rbm_account.xsd.CreateBAResponseBody body) {
    ...
    /**
     * Gets the contextIntegrator value for this CreateBAResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this CreateBAResponse.
     * 
    ...
    /**
     * Gets the body value for this CreateBAResponse.
     * 
     * @return body
     */
    public esb_rbm_account.xsd.CreateBAResponseBody getBody() {
        return body;
    }


    /**
     * Sets the body value for this CreateBAResponse.
     * 
     * @param body
     */
    public void setBody(esb_rbm_account.xsd.CreateBAResponseBody body) {
        this.body = body;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CreateBAResponse)) return false;
        CreateBAResponse other = (CreateBAResponse) obj;
