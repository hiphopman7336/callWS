/**
 * GetAccountStatusRequest_Helper.java
 *
...
public class GetAccountStatusRequest_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetAccountStatusRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", "GetAccountStatusRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", ">GetAccountStatusRequest>body"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
