/**
 * ModifyAccountBillHandlingResponse.java
 *
...
public class ModifyAccountBillHandlingResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    public ModifyAccountBillHandlingResponse() {
    }
    ...
    /**
     * Gets the contextIntegrator value for this ModifyAccountBillHandlingResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this ModifyAccountBillHandlingResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ModifyAccountBillHandlingResponse)) return false;
        ModifyAccountBillHandlingResponse other = (ModifyAccountBillHandlingResponse) obj;
