/**
 * ModifyAccountCPSRequest_Helper.java
 *
...
public class ModifyAccountCPSRequest_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ModifyAccountCPSRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", "ModifyAccountCPSRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", ">ModifyAccountCPSRequest>body"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
