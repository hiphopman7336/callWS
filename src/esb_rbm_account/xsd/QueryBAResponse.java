...
public class QueryBAResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    private esb_rbm_account.xsd.QueryBAResponseBody body;

    public QueryBAResponse() {
    }

    public QueryBAResponse(
           esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator,
           esb_rbm_account.xsd.QueryBAResponseBody body) {
    ...
    /**
     * Gets the contextIntegrator value for this QueryBAResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this QueryBAResponse.
     * 
    ...
    /**
     * Gets the body value for this QueryBAResponse.
     * 
     * @return body
     */
    public esb_rbm_account.xsd.QueryBAResponseBody getBody() {
        return body;
    }


    /**
     * Sets the body value for this QueryBAResponse.
     * 
     * @param body
     */
    public void setBody(esb_rbm_account.xsd.QueryBAResponseBody body) {
        this.body = body;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof QueryBAResponse)) return false;
        QueryBAResponse other = (QueryBAResponse) obj;
