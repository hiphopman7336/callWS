/**
 * SuspendAccountRequest_Helper.java
 *
...
public class SuspendAccountRequest_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SuspendAccountRequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", "SuspendAccountRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", ">SuspendAccountRequest>body"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
