/**
 * SuspendAccountResponse_Helper.java
 *
...
public class SuspendAccountResponse_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SuspendAccountResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", "SuspendAccountResponse"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", ">SuspendAccountResponse>body"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
