...
public class UpdateBAContractResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    public UpdateBAContractResponse() {
    }
    ...
    /**
     * Gets the contextIntegrator value for this UpdateBAContractResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this UpdateBAContractResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateBAContractResponse)) return false;
        UpdateBAContractResponse other = (UpdateBAContractResponse) obj;
