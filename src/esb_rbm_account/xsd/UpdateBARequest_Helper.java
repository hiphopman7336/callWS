...
public class UpdateBARequest_Helper {
    // Type metadata
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(UpdateBARequest.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", "UpdateBARequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://totbilling.tot.co.th/esb/rbm/account", ">UpdateBARequest>billingAccount"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
