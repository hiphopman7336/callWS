...
public class UpdateBAResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    public UpdateBAResponse() {
    }
    ...
    /**
     * Gets the contextIntegrator value for this UpdateBAResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this UpdateBAResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateBAResponse)) return false;
        UpdateBAResponse other = (UpdateBAResponse) obj;
