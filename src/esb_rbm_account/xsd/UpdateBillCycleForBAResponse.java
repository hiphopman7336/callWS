/**
 * UpdateBillCycleForBAResponse.java
 *
...
public class UpdateBillCycleForBAResponse  implements java.io.Serializable {
    private esb_rbm_account.common_integrated.ContextIntegrator contextIntegrator;

    public UpdateBillCycleForBAResponse() {
    }
    ...
    /**
     * Gets the contextIntegrator value for this UpdateBillCycleForBAResponse.
     * 
    ...
    /**
     * Sets the contextIntegrator value for this UpdateBillCycleForBAResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof UpdateBillCycleForBAResponse)) return false;
        UpdateBillCycleForBAResponse other = (UpdateBillCycleForBAResponse) obj;
